            ...
            "<div class='col-lg-4 col-md-6 col-sm-12 pb-1'>"+
                "<div class='card product-item border-0 mb-4'>"+
                    ...
                    "<div class='card-body border-left border-right text-center p-0 pt-4 pb-3'>"+
                        "<a href='wantedbook.html?bookId=" + docs.id + "' class='active'><h6 class='text-truncate mb-3'>"+ docs.data.book +"</h6></a>"+
                        "<div class='d-flex justify-content-center'>"+
                            "<h6>" + "期望價格: NT$" + docs.data.price + "</h6>"+
                        "</div>"+
                    "</div>"+
                "</div>"+
            "</div>";
...
async function showDropdown(currentTotal = [], selectedValue = "" , type = "area"){
    ...
    if (type == "reset") {
        ...
        selectedCollege = "";
        selectedDepartment = "";
        topbar.innerHTML = "<a href='wantedshop.html'>求書專區</a>";
    ...
    //假如點擊地區
        ...
        document.querySelector('.topbar').innerHTML = 
                "<a href='wantedshop.html'>求書專區</a>" + " > " + selectedArea;
        currentTotal.forEach((a)=>{
    ...
    //假如點擊學校
        ...
        document.querySelector('.topbar').innerHTML = 
                "<a href='wantedshop.html'>求書專區</a>" + " > " + selectedArea + " > " + selectedSchool;
